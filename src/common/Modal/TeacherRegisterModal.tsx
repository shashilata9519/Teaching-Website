...
export const TeacherRegisterModal = ({
  type,
  isOpen,
  closeTeacherModal,
  teacherModalState,
  ...
  const onSubmit = (data: any) => {
    ...
    fdata.append("TeachingCategory", data.TeachingCategory);
    fdata.append("gender", data.gender);
    fdata.append("register_as", "teacher");
  ...
  return (
    <>
      ...
      >
        ...
        {/* <div className="text-center underline text-xs my-3 ">
          New to xcool? Login Now
        </div> */}
      </ModalBase>
      <ToastContainer />
    </>
